...
const ProductListItem = (props) => {
    ...
    min-h-[186px] border p-4 hover:shadow-xl " >
        <div className="flex justify-between mb-7">
            ...
            <div className="w-36 flex justify-between space-x-4">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="subtext-gray text-md">{`${calculateInternetSpeed(product.uploadSpeed)}`}</p></div>
            </div>
        </div>
        <div className="flex justify-between items-center space-x-2">
            ...
            <div className="outline-none relative w-28 h-12">
                {product.providerImage ? <img alt="logo" src={product.providerImage} /> : null}
            </div>
